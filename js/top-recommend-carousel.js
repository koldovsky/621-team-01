...
//         const slideContainer = document.querySelector('.carousel-top-prods .top-slide');
...
//     function nextSlide () {
//         currentSlideIdx++;
//         if (currentSlideIdx > slides.length-1) currentSlideIdx = 0;
//         showCurrentSlide();
//     }
...
(function () {
    ...
    // }
    const productChunks = JSON.parse(productJson);
    let chunkIdx = 0;
    let productsHtml = '';
    ...
    const generateSlide = () => {
        ...
        for(const product of chunk) {
            productsHtml += `
            <div class="top-goods">
                <a href="doggy-fun-set"><img class="preview" src="${product.imgUrl}" alt="${product.name}"></a>
                <a class="top-good-name" href="doggy-fun-set">${product.name}</a>
                <p>$${product.price}</p>
                <a class="button" href="add-to-cart">Add to Card</a>
            </div>`;
...
//     function showCurrentSlide () {
//         const slideContainer = document.querySelector('.carousel-top-prods .top-slide');
//         slideContainer.innerHTML = generateSlide(chunkIdx)
//     }
